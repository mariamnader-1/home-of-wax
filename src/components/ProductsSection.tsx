...
const products: Product[] = [
  ...
  { id:3, name:'Paraffin Wax', image:'/paraffin.jpg', category:'Base Waxes', price:'$3.50', weight:'1 kg', description:'Classic paraffin wax — the most versatile candle-making wax. Strong scent throw and excellent color retention.', specs:{'Melt Point':'46–68°C','Type':'Container / Pillar','Origin':'Petroleum','Fragrance Load':'Up to 12%','Color':'Bright White'} },
